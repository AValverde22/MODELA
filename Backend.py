...
def recibirClienteQueSeEscribe():
    ...
    # PARA PODER SOLVENTAR SU DEUDA QUE LUEGO SERÁ EMPLEADO EN EL PROCEDIMIENTO pagarDeuda().
        ...
        cur.execute('UPDATE Cliente c JOIN BoletaCabecera b ON c.ID_Cliente = b.ID_Cliente SET c.ID_FP = 1 WHERE c.ID_Cliente = b.ID_Cliente AND b.ID_BoletaCabecera = %s; COMMIT;' % request.json['ID_BoletaCabeceraPagar'])
